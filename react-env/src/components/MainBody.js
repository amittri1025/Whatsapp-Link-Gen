    ...
    <div class="container w-75">
      <div class="d-sm-flex justify-content-between align-items-center">
        <form class="needs-validation">
          ...
          <label for="MobileNum" class="form-label">Enter Mobile Number</label>
          <div class="mb-3 mob-container">
            <div class="mob-code">
              <select name="countryCode" id="select" class="form-select">
                ...
                <optgroup label="Other countries">
                  ...
                  <option data-countryCode="KZ" value="997">🇰🇿 Kazakhstan (+997)</option>
            ...
            <div class="mob-num">
              <input required type="text" class="form-control" id="MobileNum" aria-describedby="emailHelp"/>
            </div>
          </div>
          <div class="err-msg">Cannot be blank
          </div>
